...
## Mix-CHOKe changed it from true to false
Queue/RED set drop_front_ false
Queue/RED set drop_rand_ true
## Mix-CHOKe changed it from false to true
...
#Queue/RED set record_size_ 10
Queue/RED set counter_ 0
Queue/RED set  candidates_ 3
Queue/RED set  drawing_factor_ 2   
